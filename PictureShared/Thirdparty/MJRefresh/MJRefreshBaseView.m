...
- (void)initial
{
    ...
    NSInteger color_ = 0x969696;
    _statusLabel.textColor = [UIColor colorWithRed:((float)((color_ & 0xFF0000) >> 16))/255.0 green:((float)((color_ & 0xFF00) >> 8))/255.0 blue:((float)(color_ & 0xFF))/255.0 alpha:1.0];
...
- (void)setFrame:(CGRect)frame
{
    ...
    // 2.时间标签
    CGFloat lastUpdateY = statusY + statusHeight;
...
#pragma mark -
#pragma mark - Method should be overide in subclass
- (CGFloat)validY
{
    return 0;
}
